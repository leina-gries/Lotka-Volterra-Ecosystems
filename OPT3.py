...
def main():
    ...
    def growth(Prey_Growth_Rate, Predator_Side_Interaction_Rate,Prey_Side_Interaction_Rate):
    ...
    def compare(all):
        ...
        guess = (growth(Prey_Growth_Rate, Predator_Side_Interaction_Rate,Prey_Side_Interaction_Rate))
        known = (growth(0.5,0.015,0.015))
   ...
   ### compare(0.5)
    #print(compare(0.5))
   # x0= (1.5, 1.5)
    res = minimize(compare, (1.5, 1.5, 20), method='SLSQP', bounds=bnds, tol=1e-6)
    print(res)
